...
const {createWithdraw, getUserWithdraws, getAllWithdraws, updateWithdrawStatus, deleteWithdraw, editWithdraw, deleteSingleWithdraw} = require('../controllers/withdrawController');
// User routes
